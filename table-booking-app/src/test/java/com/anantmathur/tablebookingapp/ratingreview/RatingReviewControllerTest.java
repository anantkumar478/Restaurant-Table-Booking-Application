...
public class RatingReviewControllerTest {
    ...
    public void testCreateRatingReview() {
        ...
        when(ratingReviewService.addRatingReview(any(RatingReview.class))).thenReturn(new RatingReviewDTO());

        ResponseEntity<RatingReviewDTO> response = ratingReviewController.createRatingReview(ratingReview);
